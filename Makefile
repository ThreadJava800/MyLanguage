...
SOURCES=LinkedList/list.h LinkedList/list.cpp tree/tree.h tree/tree.cpp lang.h front/lexicAnalyzer.cpp front/recursiveDescent.cpp front/treeBuilder.cpp main.cpp
